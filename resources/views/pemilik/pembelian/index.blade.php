...
max-width: 30%;">
    ...
    <div class="card-body">
        <p class="font-weight-bold text-center">Rp. {{ number_format(getTotalPembelian()) }}</p>
    </div>
</div>
<!-- Card -->
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <a href="{{ route('pembelian.tambah') }}" class="btn btn-info waves-effect waves-light text-white" type="button"><span class="btn-label"><i class="fa fa-plus"></i></span>Tambah</a>
                            ...
                            <div id="hapus{{ $pmb->id }}" class="modal fade" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <form method="POST">
                                            @csrf
                                            <input type="hidden" name="idpnj" value="{{ $pmb->id }}">
